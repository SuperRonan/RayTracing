...
namespace math
{
	...
	{
		 template <class floot>
		 __device__ __host__ Matrix4<floot> homogeneousScale(floot s)
		 {
			 return homogeneousScale(s, s, s);
		 }

		 template <class floot>
		 __device__ __host__ Matrix4<floot> homogeneousScale(floot sx, floot sy, floot sz)
		 {
			 Matrix4<floot> res=0;
			 res[0][0] = sx;
			 res[1][1] = sy;
		 ...
		 template <class floot>
		 __device__ __host__ Matrix4<floot> homogeneousTranslation(floot tx, floot ty, floot tz)
		 {
			 Matrix4<floot> res=homogeneousScale<floot>(1);
			 res[0][3] = tx;
			 res[1][3] = ty;
			 res[2][3] = tz;
			 return res;
		 ...
		 template <class floot>
		 __device__ __host__ Matrix4<floot> homogeneousRotationX(floot rad)
		 {
			 Matrix4<floot> res = 0;
		 ...
		 template <class floot>
		 __device__ __host__ Matrix4<floot> homogeneousRotationY(floot rad)
		 {
			 Matrix4<floot> res = 0;
			 floot cs = cos(rad), sn = sin(rad);
			 res[3][3] = 1;
		 ...
		 template <class floot>
		 __device__ __host__ Matrix4<floot> homogeneousRotationZ(floot rad)
		 {
			 Matrix4<floot> res = 0;
			 floot cs = cos(rad), sn = sin(rad);
			 res[3][3] = 1;
		 ...
		 template <class floot> 
		 __device__ __host__ Matrix4<floot> homogeneousRotation(floot rx, floot ry, floot rz, floot rad)
		 {
			 Matrix4<floot> res=0;
			 floot cs = cos(rad), sn = sin(rad);
			 res[3][3] = 1;
